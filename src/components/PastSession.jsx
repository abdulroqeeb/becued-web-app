...
const PAST_SESSION_URL = `${process.env.NODE_ENV === 'development' ? 'http://localhost:8000/api/v2/fan/pastsessions' : 'https://api-v2-staging.becued.com/api/v2/fan/pastsessions'}`;
