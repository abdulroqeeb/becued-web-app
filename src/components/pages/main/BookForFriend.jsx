                    ...
                    <div className="card-body" style={{ paddingBottom: '100px' }}>
                        <div className="row mt-5">
                            ...
                            <div className="col-md-12 mb-5">
                                ...
                                <h5 className="text-white" style={{ fontSize: '25px', fontWeight: '600' }}><Link to={"/booking"}><i class="fa fa-arrow-left" aria-hidden="true" style={{ color: '#FD9B8A' }}></i></Link> Book For A Friend</h5>
                            </div>
                            ...
                            <div className="row mx-auto col-md-8">
                                <form>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input type="text"
                                            className="form-control inputField" name="nameOfFriend" required />
                                    </div>

                                    <div className="mb-4">
                                        <label htmlFor="relationship" className="form-label text-white" style={{ fontSize: '16px', fontWeight: '600' }}>Relationship</label>
                                        <select className="form-control form-select inputField" id="relationship" required>
